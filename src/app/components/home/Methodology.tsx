    ...
    <section className="relative w-full py-24 bg-background transition-colors duration-500 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-20 space-y-6">
          ...
          <p className="font-sanstext-lg text-foreground/80 dark:text-white/70 leading-relaxed">
        ...
        <div className="relative w-full max-w-6xl mx-auto">
          ...
          <div className="hidden lg:block absolute left-1/2 -top-[8rem] bottom-0 w-[4px] -translate-x-1/2 z-0 pointer-events-none">
            <svg
          ...
          <div className="space-y-24 lg:space-y-32 relative z-10">
            {workflowSteps.map((step, index) => {
              ...
              return (
                <div
                  key={step.id}
                  className={`relative flex flex-col lg:flex-row items-center gap-12 lg:gap-[8rem] group ${isEven ? "lg:flex-row-reverse" : ""}`}
                >
                    ...
                    <div className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-foreground/10 dark:border-white/10 bg-background/50 dark:bg-medusa-base-light/40 backdrop-blur-md shadow-2xl transition-transform duration-700 group-hover:scale-[1.02]">
                      ...
                      <div className="absolute inset-4 flex flex-col gap-4">
                        ...
                        <div className="flex-1 rounded-xl border border-foreground/5 dark:border-white/5 bg-background/40 dark:bg-background/20 flex items-center justify-center relative overflow-hidden">
                          <step.Icon
                            className="w-16 h-16 text-medusa-purple dark:text-medusa-cream drop-shadow-lg transition-transform duration-500 group-hover:scale-110"
                            strokeWidth={1.5}
                          />
                  ...
                  <div className="w-full lg:w-[calc(50%-4rem)] z-10 flex flex-col items-start py-4">
                    <div className="relative z-10 flex flex-col items-start transition-all duration-500 group-hover:translate-x-2">
                      <span className="font-sans inline-block px-3 py-1 rounded-full bg-medusa-purple/10 text-medusa-purple dark:text-medusa-spark text-xs font-bold uppercase tracking-widest mb-4">
                        {step.badge}
                      </span>
