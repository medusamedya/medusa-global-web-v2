...
export default function Footer() {
  ...
  `}</style>
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-extrabold text-foreground dark:text-white tracking-tight leading-tight transition-colors duration-300">
          ...
          <div className="relative inline-flex overflow-hidden rounded-full p-[2px] shadow-lg group flex-shrink-0">
            ...
            >
              <span className="font-sans text-base font-bold text-foreground dark:text-white group-hover:text-medusa-base-dark dark:group-hover:text-white transition-colors">
                Bize Ulaşın
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-6">
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div className="flex flex-col justify-center">
                <span className="font-heading text-2xl font-black tracking-widest text-foreground dark:text-white uppercase transition-colors duration-300 leading-tight">
                  MEDUSAGLOBAL
                </span>
                <span className="font-sans text-[10px] font-medium tracking-[0.2em] uppercase text-medusa-purple dark:text-medusa-spark mt-0.5">
                  ACCELERATION & CONSULTANCY
                </span>
              </div>
            </div>
            <p className="font-sans text-foreground/70 dark:text-white/60 text-sm leading-relaxed max-w-sm transition-colors duration-300">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <Link
                href="#"
                className="w-10 h-10 rounded-full border border-foreground/10 dark:border-white/10 flex items-center justify-center text-foreground/60 dark:text-white/60 hover:border-medusa-purple hover:text-medusa-purple dark:hover:border-medusa-spark dark:hover:text-medusa-spark transition-all duration-300 hover:-translate-y-1"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="18"
          ...
          <div className="lg:col-span-3 flex flex-col space-y-6">
            <h4 className="font-heading text-sm font-bold text-foreground dark:text-white uppercase tracking-widest transition-colors duration-300">
              Çözümlerimiz
            </h4>
            <ul className="space-y-4">
              {[
                ...
                <li key={idx}>
                  <Link
                    href="#"
                    className="font-sans text-foreground/70 dark:text-white/60 text-sm hover:text-medusa-purple dark:hover:text-medusa-spark transition-colors duration-300 flex items-center gap-2 group"
                  >
              ...
              {["Hakkımızda", "Vaka Çalışmaları", "Manifesto", "Kariyer"].map(
                (item, idx) => (
                  <li key={idx}>
                    <Link
                      href="#"
                      className="text-foreground/70 dark:text-white/60 text-sm hover:text-medusa-purple dark:hover:text-medusa-spark transition-colors duration-300 flex items-center gap-2 group"
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-medusa-purple/50 dark:bg-medusa-spark/50 scale-0 group-hover:scale-100 transition-transform"></span>
                      {item}
                    </Link>
          ...
          <div className="lg:col-span-3 flex flex-col space-y-6">
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center gap-3 text-foreground/70 dark:text-white/60 text-sm transition-colors duration-300">
                ...
                <Link
                  href="mailto:hello@medusaglobal.com"
                  className="hover:text-medusa-purple dark:hover:text-medusa-spark transition-colors"
                >
        ...
        <div className="w-full pt-8 border-t border-foreground/10 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 transition-colors duration-500">
          <p className="font-sans text-foreground/50 dark:text-white/50 text-xs transition-colors duration-300">
            &copy; 2026 Medusa Global. Tüm hakları saklıdır.
          </p>
          <div className="flex items-center gap-6">
            <Link
              href="#"
              className="text-foreground/50 dark:text-white/50 hover:text-foreground dark:hover:text-white text-xs transition-colors duration-300"
            >
              Gizlilik Politikası
            </Link>
            <Link
